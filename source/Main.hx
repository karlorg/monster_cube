...
class Main extends Sprite {
    var gameWidth:Int = 320; // Width of the game in pixels (might be
                             // less / more in actual pixels depending
                             // on your zoom).
    ...
    var framerate:Int = 60; // How many frames per second the game
                            // should run at.
    var skipSplash:Bool = false; // Whether to skip the flixel splash
                                 // screen that appears in release mode.
    var startFullscreen:Bool = false; // Whether to start the game in
                                      // fullscreen on desktop targets
